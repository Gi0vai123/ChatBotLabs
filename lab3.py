...
Original file is located at
    https://colab.research.google.com/drive/1YBXwU2DK4jlpc95WrYdQrRf7FthJ0PQb
"""
...
dados_imobiliaria = [
    ...
    ("Como faço para rescindir o contrato do imóvel?", "cancelar_contrato"),
    ("Preciso solicitar o cancelamento do contrato", "cancelar_contrato"),
    ("Quero encerrar meu contrato de locação", "cancelar_contrato"),
    ("Gostaria de saber como funciona o distrato do contrato", "cancelar_contrato")
]
...
print(
    f"Dataset carregado com {len(df)} mensagens divididas "
    f"em {df['intencao'].nunique()} intenções."
)
...
RESPOSTAS_PADRAO = {
    "comprar_imovel": (
        ...
        "Você pode conferir nosso catálogo de imóveis à venda em nosso site "
        "www.imobiliaria.com/vendas ou aguardar que um de nossos corretores "
    ...
    "2via_boleto_contrato": (
        ...
        "acesse a Área do Cliente em www.imobiliaria.com/cliente informando "
        "seu CPF e senha. Lá você baixa a 2ª via atualizada em segundos."
    ),
    "cancelar_contrato": (
        "Contratos e Distrato: Para solicitar o cancelamento ou distrato "
        "do contrato, entre em contato com nosso setor de contratos. "
        "Nossa equipe irá orientar sobre documentos, prazos e condições "
...
def processar_atendimento_sac(mensagem_usuario: str):
    ...
    if confianca >= LIMIAR_CONFIANCA:
        ...
        texto_resposta = (
            ...
            "Estou transferindo agora mesmo sua conversa para um de nossos "
            "atendentes. Por favor, aguarde um momento."
        )

    card_resposta = f"""
    <div style="background-color: #f0f4f9; border-left: 5px solid #2b5c8f; padding: 15px; border-radius: 8px; margin-top: 10px;">
        <h4 style="margin: 0 0 8px 0; color: #2b5c8f;">
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            input_texto = gr.Textbox(
                lines=4,
                placeholder="Ex: Quero cancelar meu contrato...",
